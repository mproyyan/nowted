<div class="bg-secondary rounded-lg px-4 py-2">
  <div class="flex items-start justify-between">
    <div class="flex items-start">
      <svg class="mr-2 w-6 text-white shrink-0" fill="none" stroke="currentColor" stroke-width="1.5" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
    ...
    <div class="hover:bg-gactive relative rounded-full p-0.5">
      ...
      <div class="bg-gactive absolute right-7 top-1/2 w-48 -translate-y-1/2 rounded-md px-4 py-2 text-sm text-white hidden">
        {{ $slot }}
      </div>
    </div>
  </div>
