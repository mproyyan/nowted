...
@section('content')
  <div class="px-4">
    <!-- Page Title -->
    <h2 class="text-xl font-semibold text-white">My Notes</h2>
    <!-- action button -->
    <div class="mt-2 flex">
      <button class="bg-bactive mr-2 flex items-center rounded-md px-2 py-1 text-white">
    ...
    <div class="mt-8">
      ...
      <div class="mt-2 space-y-3 sm:grid sm:grid-cols-2 sm:gap-2 sm:space-y-0 md:grid-cols-3">
        ...
        @foreach ($notes as $note)
          ...
          {{-- <div x-data="{ open: false }" class="rounded-lg bg-secondary px-4 py-2">
            <div class="flex items-start justify-between">
              <!-- rightside -->
              <div class="flex items-start">
                <svg class="mr-2 w-8 text-white" fill="none" stroke="currentColor" stroke-width="1.5" viewBox="0 0 24 24"
              ...
              <!-- leftside -->
              <div @click="open = !open" class="relative rounded-full p-0.5 hover:bg-gactive">
                <svg class="w-5 text-white" fill="none" stroke="currentColor" stroke-width="1.5" viewBox="0 0 24 24"
                  xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
                  <path stroke-linecap="round" stroke-linejoin="round"
                ...
                <!-- action menu -->
                <div x-show="open" @click.outside="open = false" x-transition class="absolute right-7 top-1/2 w-48 -translate-y-1/2 rounded-md bg-gactive px-4 py-2 text-sm text-white">
                  <ul class="space-y-3">
                    <a href="#" class="block">
                      <li class="flex items-center">
            ...
            <p class="mt-2 text-sm text-gtext">Lorem ipsum dolor sit amet consectetur adipisicing elit. Assumenda laboriosam,
              aspernatur persp...</p>
          </div> --}}
        @endforeach
      </div>
