...
@section('content')
    <div class="px-4">
        <!-- Page Title -->
        <h2 class="text-xl font-semibold text-red-300 sm:text-3xl">Catatan Saya</h2>
        <!-- action button -->
        <div x-data="{ open: false }" class="mt-2 flex">
            <button @click="open = !open" class="bg-bactive mr-2 flex items-center rounded-md px-2 py-1 text-white">
                <svg class="mr-1.5 w-5" fill="none" stroke="currentColor" stroke-width="1.5" viewBox="0 0 24 24"
            ...
            <x-modal :url="route('folder.create')" title="Create New Folder" confirm="Create">
                @csrf
                <svg fill="none" class="mx-auto mt-2 w-20 text-white" stroke="currentColor" stroke-width="1.5"
                                ...
                                <li>
                                    <form class="block" action="{{ route('favorites.note') }}" method="post">
                                        ...
                                        <button type="submit" class="flex w-full items-center">
                                            <svg class="mr-2 w-5" fill="none" stroke="currentColor" stroke-width="1.5"
                                                viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
                                                <path stroke-linecap="round" stroke-linejoin="round"
                            ...
                            <ul class="space-y-3">
                                ...
                                <li>
                                    <form class="block" action="{{ route('favorites.folder') }}" method="post">
                                        ...
                                        <button type="submit" class="flex w-full items-center">
                                            <svg class="mr-2 w-5" fill="none" stroke="currentColor"
                                ...
                                <li x-data="{ open: false }">
                                    ...
                                    <template x-teleport="body">
                                        <x-modal :url="route('folder.update')" title="Edit Folder" confirm="Save Changes">
                                            ...
                                            <svg fill="none" class="mx-auto mt-2 w-20 text-white"
